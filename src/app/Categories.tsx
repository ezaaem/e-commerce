...
const Categories: React.FC = () => {
  return (
    <div className="pt-20 pb-12 border-b-2">
      ...
      <div className=" grid grid-cols-2 max-sm:w-4/5 md:grid-cols-3 lg:grid-cols-6 gap-3 mx-auto justify-center ">
        <div className="flex  justify-center items-center w-44 h-36 border-2 hover:bg-red-500  gap-3">
          <div>
            <svg
              ...
              fill="none"
            >
              <g clip-path="url(#clip0_9589_1693)">
                <path
              ...
              <defs>
                <clipPath id="clip0_9589_1693">
                  <rect width="56" height="56" fill="white" />
                </clipPath>
              </defs>
            </svg>
            <p className="pt-2">Phones</p>
          </div>
        </div>
        <div className=" flex flex-col  justify-center items-center w-44 h-36 hover:bg-red-500 border-2  ">
          <svg
            className=""
            xmlns="http://www.w3.org/2000/svg"
            width="56"
          ...
          >
            ...
            <defs>
              <clipPath id="clip0_9589_78">
                <rect width="56" height="56" fill="white" />
              </clipPath>
            </defs>
          </svg>
          <p className="pt-2">Computers</p>
        </div>
        <div className="flex flex-col justify-center items-center w-44 h-36 hover:bg-red-500 border-2  gap-2">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="56"
            height="56"
            ...
            fill="none"
          >
            <g clip-path="url(#clip0_9589_1297)">
              <path
            ...
            <defs>
              <clipPath id="clip0_9589_1297">
                <rect width="56" height="56" fill="white" />
              </clipPath>
            </defs>
          </svg>
          <p className="pt-">SmatWatche</p>
        </div>
        <div className="flex flex-col justify-center items-center w-44 h-36 hover:bg-red-500 border-2  gap-2">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            ...
            fill="none"
          >
            <g clip-path="url(#clip0_9589_1225)">
              <path
        ...
        <div className="flex flex-col justify-center items-center w-44 h-36 hover:bg-red-500 border-2  gap-2">
          <svg
            ...
            fill="none"
          >
            <g clip-path="url(#clip0_9589_3077)">
              <path
        ...
        <div className="flex  justify-center items-center w-44 h-36 border-2 hover:bg-red-500  gap-2">
          <div>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="56"
              ...
              fill="none"
            >
              <g clip-path="url(#clip0_9589_1959)">
                <path
