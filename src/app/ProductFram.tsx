...
// Update the ProductFrame to receive products as a prop
        ...
        {products.map((product) => (
          <li key={product.id}>
            <div className="relative w-72 h-64 flex justify-center items-center rounded-md border-2 border-slate-200">
              ...
              />
              <span className="absolute top-3 left-2 text-white w-14 h-7 bg-red-500 rounded-md text-xs flex justify-center pt-1.5">
                -70%
              </span>
              <span className="absolute w-8 h-8 rounded-full border-2 border-slate-200 flex justify-center items-center top-3 right-2">
                <svg
              ...
              <span className="absolute w-8 h-8 rounded-full border-2 border-slate-200 flex justify-center items-center top-12 right-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
